...
final class ProductController
{
    ...
    public static function save(): void
    {
        try {
            ...
            $errors = [];
            // Si données POST absnetes (upload trop lourd), déclencher une exception.
            ...
            if (!$errors) {
                ...
                if ($upload->complete && is_uploaded_file($upload->tmpFilePath)) {
                    ...
                    $image->copyResize(Cfg::get('imgSmallWidth'), Cfg::get('imgSmallHeight'), Cfg::get('imgProductsDir') . "/product_{$product->idProduct}_small.jpg");
                    $image->copyResize(Cfg::get('imgBigWidth'), Cfg::get('imgBigHeight!;'), Cfg::get('imgProductsDir') . "/product_{$product->idProduct}_big.jpg");
                } else {
        ...
        (ImageException|UploadException $e) {
            $errors[] = $e->getMessage();
